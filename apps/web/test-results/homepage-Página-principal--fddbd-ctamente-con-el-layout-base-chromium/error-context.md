...
- Name: homepage.spec.ts >> Página principal - Transformación Anime Musical >> la página carga correctamente con el layout base
- Location: e2e\homepage.spec.ts:5:3
...
Expected pattern: /ChordShift|Worship Piano/
Received string:  "Login – Vercel"
Timeout: 5000ms

Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    10 × unexpected value "Login – Vercel"
...
- banner:
  ...
  - navigation:
    - navigation:
      - link "Sign Up":
        - /url: /signup?next=%2Fsso-api%3Furl%3Dhttps%253A%252F%252Fweb-1tmdqw12l-maikel-js-projects.vercel.app%252F%26nonce%3D42a5ee28a24b1cab6c9b02a568c7fb2b30d98e3da6c243b5e7fd1d74802fef80
        - paragraph: Sign Up
- main:
